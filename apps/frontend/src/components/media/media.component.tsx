    ...
    <>
      <div className="b1 flex flex-col gap-[8px] bg-bigStrip rounded-bl-[8px] select-none w-full">
        <div className="flex gap-[10px] items-end">
          <Button
            onClick={showModal}
            className="ms-[10px] !px-[0] !h-[80px] w-[80px] rounded-[4px] gap-[8px] !text-primary justify-center items-center flex border border-dashed border-newBgLineColor bg-newColColor"
          >
          ...
          {!!currentMedia && (
            <ReactSortable
              ...
              className="flex gap-[10px] sortable-container flex-wrap"
              animation={200}
              swap={true}
              handle=".dragging"
            >
                  ...
                  <div className="cursor-pointer rounded-[4px] w-[80px] h-[80px] border-2 border-tableBorder relative flex transition-all">
                    <div className="dragging text-sm absolute pe-[1px] z-[10] pb-[3px] -start-[4px] -top-[4px] bg-blue-700 cursor-move rounded-full w-[15px] h-[15px] text-white flex justify-center items-center">
                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.5 6.00073C11.3284 6.00073 12 5.32916 12 4.50073C12 3.67231 11.3284 3.00073 10.5 3.00073C9.67155 3.00073 9 3.67231 9 4.50073C9 5.32916 9.67155 6.00073 10.5 6.00073Z" fill="white"/>
                        <path d="M4.5 6.00073C5.32843 6.00073 6 5.32916 6 4.50073C6 3.67231 5.32843 3.00073 4.5 3.00073C3.67157 3.00073 3 3.67231 3 4.50073C3 5.32916 3.67157 6.00073 4.5 6.00073Z" fill="white"/>
                        <path d="M10.5 12.0007C11.3284 12.0007 12 11.3292 12 10.5007C12 9.67229 11.3284 9.00073 10.5 9.00073C9.67155 9.00073 9 9.67229 9 10.5007C9 11.3292 9.67155 12.0007 10.5 12.0007Z" fill="white"/>
                        <path d="M4.5 12.0007C5.32843 12.0007 6 11.3292 6 10.5007C6 9.67229 5.32843 9.00073 4.5 9.00073C3.67157 9.00073 3 9.67229 3 10.5007C3 11.3292 3.67157 12.0007 4.5 12.0007Z" fill="white"/>
                      </svg>
                    </div>
                    ...
                    <div className="w-full h-full relative group">
                      <div
                        ...
                        className="border border-white absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] bg-black/80 rounded-[10px] opacity-0 group-hover:opacity-100 transition-opacity z-[100]"
                      >
                        <svg
                          width="40"
                          height="40"
                    ...
                    <div
                      ...
                      className="leading-[6px] rounded-full w-[15px] h-[15px] bg-red-800 text-white flex justify-center items-center absolute -end-[4px] -top-[4px]"
                    >


                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.25 11.25L7.5 7.5M7.5 7.5L3.75 3.75M7.5 7.5L11.25 3.75M7.5 7.5L3.75 11.25" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
