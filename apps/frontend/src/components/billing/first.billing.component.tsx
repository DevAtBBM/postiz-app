...
export const FirstBillingComponent = ({ onSkip }: { onSkip?: () => void }) => {
  ...
  const showYouTube = () => {
    modals.openModal({
      title: 'Grow Fast With Postnify (Play the video)',
      children: (
        <iframe
      ...
      <>
        ...
        <div className="flex" onClick={showYouTube}>
          <div className="tablet:mb-[32px] cursor-pointer mt-[32px] flex gap-[10px] items-center underline hover:font-[700]">
            ...
            <div>See the power of Postnify (click here)</div>
          </div>
        </div>
      ...
      <div className="h-[92px] px-[80px] tablet:px-[32px] mobile:!px-[16px] py-[20px] flex border-b border-newColColor">
        ...
        <div className="flex items-center">
          ...
          {onSkip && (
            <button
              onClick={onSkip}
              className="ml-[16px] text-sm text-textItemBlur hover:text-newTextColor underline underline-offset-2 transition-colors"
            >
